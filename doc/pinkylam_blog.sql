...
CREATE TABLE `article_cate_label` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='文章类别标签关系表';
...
CREATE TABLE `cate_label` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='类别标签表';
...
CREATE TABLE `memo_remind` (
  ...
  `CREATE_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='备忘提醒';

-- ----------------------------
-- Records of memo_remind
-- ----------------------------
INSERT INTO `memo_remind` VALUES ('1', '1', '123213123', '2017-08-08 15:26:26', '2017-08-08 15:26:39');
